 ...
 * [NavigationDetailFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [NavigationDetailFragment.newInstance] factory method to
...
class NavigationDetailFragment : Fragment() {
    ...
    lateinit var binding: FragmentNavigationDetailBinding
    ...
    companion object {
         ...
         * @return A new instance of fragment NavigationDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                NavigationDetailFragment().apply {
