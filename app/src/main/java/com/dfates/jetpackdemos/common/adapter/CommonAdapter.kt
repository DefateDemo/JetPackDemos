 ...
 */
class CommonAdapter<M>(mContext: Context, layoutId: Int, mDatas: List<M?>?, var convert: (holder: SimpleViewHolder, data: M?, position: Int) -> Unit) : BaseSimpleAdapter<M, SimpleViewHolder>(mContext, layoutId, mDatas) {
